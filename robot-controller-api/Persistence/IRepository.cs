...
namespace robot_controller_api.Persistence
{
    ...
    {
        private const string CONNECTION_STRING = "Host=localhost;Username=postgres;Password=;Database=sit331";
        ...
        public List<T> ExecuteReader<T>(string sqlCommand, NpgsqlParameter[] dbParams = null) where T : class, new()
        {
            ...
            while (dr.Read())
            {
                var entity = new T();
                dr.MapTo(entity);
                // AUTOMATIC ORM WILL HAPPEN HERE. MapTo does not exist yet.MS
                entities.Add(entity);
            }
            return entities;
        }
